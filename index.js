...
if(command === "help") {
  ...
  // These commands are more specifically for 1 use

  if(command === "botcaferules") {
    const embed = new Discord.RichEmbed()
    ...
    .setTimestamp()
    .setURL("https://discordapp.com/api/oauth2/authorize?client_id=665450246939082783&permissions=0&scope=bot")
    .addField("[1]", "Be respectful to others")
    .addField("[2]", "For your safety don't share your personal info or bot token")
    .addField("[3]", "Don't 'Steal' other peoples code. ask for permission")
    .addField("[4]", "No Racism, Facism or Sexism is permitted in 'public' channels")
    .addField("[5]", "No harassent of others")
    .addField("[6]", "If a moderator says you are doing the wrong thing, they have the right to mute you")
    message.channel.send({embed});
    message.delete();
    }
...
message.channel.send(emb)
  ...
  if(command === "webhook") {
    let args = message.content.split(" ").slice(1);
      message.channel.createWebhook("Webhook", "https://i.imgur.com/p2qNFag.png")
        ...
        .catch(console.error);
        const embed = new Discord.RichEmbed()
        .setAuthor("WhatTheDuck", "http://wrecked256.xyz/github/Images/duck.jpg")
        .setColor(0x00AE86)
        .setFooter("Webhook Embed", "http://wrecked256.xyz/github/Images/ducks.jpg")
        .setThumbnail("http://wrecked256.xyz/github/Images/clipart%20cog.png")
        .setTimestamp()
        .setURL("https://discordapp.com/api/oauth2/authorize?client_id=665450246939082783&permissions=8&scope=bot")
        .addField("Webhook created", "check your DM's for a link")
        message.channel.send({embed});
  }
 ...
 if(command === "invite") {
  ...
  .setFooter("Invite", "http://wrecked256.xyz/github/Images/ducks.jpg")
  .setThumbnail("http://wrecked256.xyz/github/Images/DuckStaringIntently.jpg")
  .setTimestamp()
  .setURL("https://discordapp.com/api/oauth2/authorize?client_id=665450246939082783&permissions=8&scope=bot")
  .addField("Click 'Invite' for the link", "or https://bit.ly/WTDuckBot")
  message.channel.send({embed});
  message.delete();
  }
