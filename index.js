...
client.on("message", async message => {
  ...
  .setTitle("WhatTheDucks's command list")
  .setAuthor("WhatTheDuck", "https://i.imgur.com/BvFaeyW.jpg")
  /*
   * Alternatively, use "#00AE86", [0, 174, 134] or an integer number.
   */
  .setColor(0x00AE86)
  .setDescription("A list of commands for this bot")
  ...
  .addField("d!say",
    "repeats what the user says, usage: d!say what you want the bot to repeat")
  .addField("d!kick",
    "kicks the mentioned user, usage: d!kick @the person you want to kick")
  .addField("d!ban",
    "bans the mentioned user")
  .addField("d!purge",
    "purges messages above the command, usage: d!purge 10")
  .addField("d!help",
    "gives you a list of commands for this bot usage: d!help")
